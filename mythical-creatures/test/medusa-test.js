...
describe('Medusa', function() {
  ...
  it('should have a name', function() {
   ...
   var elizabeth = new Medusa("Elizabeth");
   var delayna = new Medusa("Delayna");
    // assert that the first medusa's name is your name
    // assert that the second medusa's name is the other name
    assert.equal(elizabeth.name, "Elizabeth");
    assert.equal(delayna.name, "Delayna");
  });
  ...
  it('should gain a statue when staring at a person', function() {
    ...
    //asserting Statue is an instance of
...
describe('Person', function() {
  ...
  it('should be feel frightened', function() {
